    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "078b557d-8a21-4d37-bcb5-f3eaad579445", "b1328125-af3d-4775-a05b-f8f9d2751bab", "admin", "ADMIN" },
                    { "b5a0b9dd-05fa-465c-b8b3-3f55805ea893", "41e7931a-8c04-4578-b956-71f198a594ef", "user", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 6, "Cheese 1Kg", 10.99m },
                    { 2, 5, "Breads Package", 3.99m },
                    { 3, 4, "Fish Salmon 1Kg", 18.19m },
                    { 4, 1, "Desserts Package x 5", 8m },
                    { 5, 1, "Candie Box", 7.29m },
                    { 6, 5, "Pasta Package x 10", 18.99m },
                    { 7, 1, "Desserts Salmon 1 Kg", 18.99m },
                    { 8, 4, "Wild Dorade 1 Piece(600-700 gr)", 18.99m }
                });
